...
class RegistrationSettings(models.Model):
    ...
    handbook_url = models.URLField(default="https://drive.google.com/file/d/13rx7WxS8U0DYaQ0w4gv7dxd0k1II4kw6/view?usp=drivesdk")
    ...
    def current(cls):
        obj, _ = cls.objects.get_or_create(
            ...
            defaults={
                ...
                "handbook_url": "https://drive.google.com/file/d/13rx7WxS8U0DYaQ0w4gv7dxd0k1II4kw6/view?usp=drivesdk",
