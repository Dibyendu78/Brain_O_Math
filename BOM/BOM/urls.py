...
urlpatterns = [
    ...
    path("api/coordinator/admit-cards/student/<int:student_id>", coordinator_views.download_admit_card),
    ...
    path("api/admin/results/stats", admin_views.api_result_stats),
    ...
    path("api/admin/admit-cards/stats", admin_views.api_admit_card_stats),
    ...
    path("api/admin/export-marks", admin_views.api_export_marks),
